package com.dedecms.health.aliyunoss;
...
public class AliyunUtils {
    ...
    public  static  String accessKeyId = "LTAILlflJAmVwH25";
    public  static String accessKeySecret = "vxbZLEZVsNh7y5eljTIzbFWbrSTexN";
    // Endpoint以杭州为例，其它Region请按实际情况填写。
    public  static  String endpoint = "http://oss-cn-hangzhou.aliyuncs.com";
    public  static  String bucketName = "shheima106";//  空间名称
